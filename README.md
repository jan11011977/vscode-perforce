...
[![GitHub issues](https://img.shields.io/github/issues/jan11011977/vscode-perforce.svg)](https://github.com/jan11011977/vscode-perforce/issues)
...
Keep in mind this is still in early beta! Explore and leave your comments on [GitHub](https://github.com/jan11011977/vscode-hexdump/issues)
...
1. Search the [existing issue on GitHub](https://github.com/jan11011977/vscode-perforce/issues?utf8=✓&q=is%3Aissue)
1. If you can't find your problem, [create an issue](https://github.com/jan11011977/vscode-perforce/issues/new), and please include the logs when possible
  
  
#### **Q:** Operations on a large files fail
**A:** Increase `perforce.maxBuffer` in your user settings.  
[more...](https://github.com/jan11011977/vscode-perforce/issues/116)
  
  
#### **Q:** There is a lot of duplicated changelists showing up in the `Source Control` viewlet
**A:** Please provide your Perforce Output logs in [issue #62](https://github.com/jan11011977/vscode-perforce/issues/62)
...
[more...](https://github.com/jan11011977/vscode-perforce/issues/47)
...
* Based on the Perforce plugin by S.Levesque
